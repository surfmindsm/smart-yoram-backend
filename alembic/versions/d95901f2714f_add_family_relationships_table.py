...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['head_member_id'], ['members.id'], ),
    ...
    op.drop_constraint('attendances_member_id_service_date_service_type_key', 'attendances', type_='unique')
    ...
    op.add_column('calendar_events', sa.Column('event_time', sa.String(), nullable=True))
...
def downgrade() -> None:
    ...
    op.create_index('idx_sms_history_church', 'sms_history', ['church_id'], unique=False)
    ...
    op.create_index('idx_calendar_events_date', 'calendar_events', ['event_date'], unique=False)
    ...
    op.create_index('idx_attendances_member_id', 'attendances', ['member_id'], unique=False)
    op.create_index('idx_attendances_date', 'attendances', ['service_date'], unique=False)
    op.create_unique_constraint('attendances_member_id_service_date_service_type_key', 'attendances', ['member_id', 'service_date', 'service_type'])
