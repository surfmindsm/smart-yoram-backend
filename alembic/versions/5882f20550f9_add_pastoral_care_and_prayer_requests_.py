...
def upgrade() -> None:
    ...
    op.create_table('pastoral_care_requests',
        ...
        sa.Column('request_type', sa.String(length=50), server_default='general', nullable=True),
        ...
        sa.ForeignKeyConstraint(['assigned_pastor_id'], ['users.id'], ),
    ...
    op.create_table('prayer_requests',
        ...
        sa.Column('prayer_type', sa.String(length=50), server_default='general', nullable=True),
    ...
    op.create_table('prayer_participations',
        ...
        sa.Column('church_id', sa.Integer(), nullable=False),
        sa.Column('participated_at', sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=True),
        sa.ForeignKeyConstraint(['church_id'], ['churches.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['member_id'], ['users.id'], ondelete='CASCADE'),
