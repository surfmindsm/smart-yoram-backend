...
def upgrade():
    ...
    op.add_column('members', 
        sa.Column('transfer_church', sa.String(), nullable=True)
    )
    op.add_column('members', 
    ...
    op.create_table('calendar_events',
        ...
        sa.Column('event_type', sa.String(), nullable=True),  # birthday, anniversary, service, etc
        sa.Column('event_date', sa.Date(), nullable=False),
        sa.Column('is_recurring', sa.Boolean(), nullable=True, default=False),
        sa.Column('recurrence_pattern', sa.String(), nullable=True),  # yearly, monthly, weekly
    ...
    op.create_table('notifications',
        ...
        sa.Column('title', sa.String(), nullable=False),
        sa.Column('message', sa.Text(), nullable=False),
        sa.Column('notification_type', sa.String(), nullable=True),  # birthday, event, announcement
    ...
    op.create_table('family_relationships',
        ...
        sa.Column('relationship_type', sa.String(), nullable=False),  # 부모, 자녀, 배우자, 형제, 자매 등
        sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
        sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
        sa.ForeignKeyConstraint(['church_id'], ['churches.id'], ),
        sa.ForeignKeyConstraint(['member_id'], ['members.id'], ),
    ...
    op.create_index('idx_family_relationships_member', 'family_relationships', ['member_id'])
    op.create_index('idx_family_relationships_related', 'family_relationships', ['related_member_id'])
