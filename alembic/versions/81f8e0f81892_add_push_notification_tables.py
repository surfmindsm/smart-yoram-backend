...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_push_notifications_id"), "push_notifications", ["id"], unique=False
    )
    op.create_table(
        "user_devices",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.Column(
            "platform",
            sa.Enum("IOS", "ANDROID", "WEB", name="deviceplatform"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_user_devices_device_token"),
        "user_devices",
        ["device_token"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_notification_recipients_id"),
        "notification_recipients",
        ["id"],
        unique=False,
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_notification_recipients_id"), table_name="notification_recipients"
    )
