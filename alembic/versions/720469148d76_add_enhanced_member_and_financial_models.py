...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_daily_ministry_reports_id"),
        "daily_ministry_reports",
        ["id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_education_notes_id"), "education_notes", ["id"], unique=False
    )
    op.create_table(
        "files",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_member_addresses_id"), "member_addresses", ["id"], unique=False
    )
    op.create_table(
        "member_church_school",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("member_id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_member_church_school_id"), "member_church_school", ["id"], unique=False
    )
    op.create_table(
        "member_contacts",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_member_contacts_id"), "member_contacts", ["id"], unique=False
    )
    op.create_table(
        "member_family",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_member_ministry_id"), "member_ministry", ["id"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_member_status_history_id"),
        "member_status_history",
        ["id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_member_vehicles_id"), "member_vehicles", ["id"], unique=False
    )
    op.create_table(
        "sacraments",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_search_presets_id"), "search_presets", ["id"], unique=False
    )
    op.create_table(
        "services",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_stats_snapshots_id"), "stats_snapshots", ["id"], unique=False
    )
    op.create_table(
        "transfers",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_daily_ministry_links_id"), "daily_ministry_links", ["id"], unique=False
    )
    op.create_table(
        "financial_reports",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_receipt_snapshots_id"), "receipt_snapshots", ["id"], unique=False
    )
    ...
    op.add_column(
        "members", sa.Column("registration_background", sa.Text(), nullable=True)
    )
    op.add_column("members", sa.Column("head_relationship", sa.String(), nullable=True))
    op.add_column(
        "members", sa.Column("is_new_family_head", sa.Boolean(), nullable=True)
    )
    op.add_column(
        "members", sa.Column("inviter1_member_id", sa.Integer(), nullable=True)
    )
    op.add_column(
        "members", sa.Column("inviter2_member_id", sa.Integer(), nullable=True)
    )
    ...
    op.create_index(
        op.f("ix_pastoral_care_requests_id"),
    ...
    op.drop_constraint(
        "prayer_participations_prayer_request_id_member_id_key",
        "prayer_participations",
        type_="unique",
    )
    op.create_index(
        op.f("ix_prayer_participations_id"),
        "prayer_participations",
        ["id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_prayer_participations_id"), table_name="prayer_participations"
    )
    op.create_unique_constraint(
        "prayer_participations_prayer_request_id_member_id_key",
        "prayer_participations",
        ["prayer_request_id", "member_id"],
    )
    op.create_index(
    ...
    op.drop_index(
        op.f("ix_pastoral_care_requests_id"), table_name="pastoral_care_requests"
    )
    op.create_index(
    ...
    op.drop_index(
        op.f("ix_member_status_history_id"), table_name="member_status_history"
    )
    ...
    op.drop_index(
        op.f("ix_daily_ministry_reports_id"), table_name="daily_ministry_reports"
    )
