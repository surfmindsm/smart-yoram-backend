...
class CommunityApplication(Base):
    ...
    )  # 'company', 'individual', 'musician', 'church_admin', etc.
    ...
    # 새로 추가: 약관 동의
    agree_terms = Column(Boolean, default=False, nullable=False)  # 이용약관 동의
    agree_privacy = Column(
        Boolean, default=False, nullable=False
    )  # 개인정보처리방침 동의
    agree_marketing = Column(Boolean, default=False, nullable=False)  # 마케팅 수신 동의
