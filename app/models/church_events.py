...
# RecruitmentStatus removed - using CommonStatus instead
...
class ChurchEvent(Base):
    ...
    title = Column(String(255), nullable=False, comment="행사 제목")
    ...
    status = Column(Enum(CommonStatus), nullable=True, default=CommonStatus.ACTIVE, comment="상태")
