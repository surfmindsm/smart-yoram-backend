...
class MemberBase(BaseModel):
    ...
    # Enhanced fields from requirements (레퍼런스 요구사항) - TEMPORARILY DISABLED
    # These will be re-enabled after database migration
    ...
    # Custom fields (자유필드 1~12) - TEMPORARILY DISABLED
