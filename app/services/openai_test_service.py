...
어떤 부분이 궁금하신가요?"""
        elif ("올해" in user_message or "총" in user_message or "전체" in user_message) and "헌금" in user_message:
            content = """올해 헌금 총액을 조회해드리겠습니다.

📊 **2025년 헌금 총액 (8월까지):**
- 총 헌금액: **0원**
- 헌금 건수: 0건

현재 헌금 기록이 없는 상태입니다. 이는 다음 중 하나의 이유일 수 있습니다:
...
헌금 입력이나 시스템에 문제가 있다면 빠른 시일 내에 해결하시기 바랍니다."""
        else:
