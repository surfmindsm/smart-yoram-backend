...
class ChurchDataService:
    ...
    async def test_connection(self, config: ChurchDatabaseConfig) -> Dict:
        ...
        try:
            ...
            with engine.connect() as conn:
                ...
                return {"connected": True, "tables_found": tables, "error": None}

        except Exception as e:
            logger.error(f"Database connection test failed: {e}")
            return {"connected": False, "tables_found": [], "error": str(e)}
    ...
    async def query_attendance_stats(
        self, church_id: int, period: str = "month", db: Session = None
    ) -> Dict:
        ...
        try:
            ...
            with engine.connect() as conn:
                ...
                return {"query_result": stats, "summary": f"최근 {period} 출석 통계"}
    ...
    async def query_member_info(
        self, church_id: int, search_term: str = None, db: Session = None
    ) -> Dict:
    ...
    async def query_events(
        self, church_id: int, upcoming: bool = True, db: Session = None
    ) -> Dict:
        """Get church events"""
        try:
            config = (
...
async def get_church_data(
    church_id: int, data_types: List[str], db: Session, **kwargs
) -> Dict:
    ...
    for data_type in data_types:
        if data_type == "attendance":
            ...
            results["events"] = await service.query_events(church_id, db=db, **kwargs)
