...
# 교회 소식 라우터
api_router.include_router(
    church_news.router, prefix="/community", tags=["church_news"]
)
...
# 음악팀 지원자 라우터 (신규)
api_router.include_router(
    music_team_seekers.router, tags=["music_team_seekers"]
)

# 커뮤니티 이미지 업로드 라우터
api_router.include_router(
    community_images.router, prefix="/community", tags=["community_images"]
)
