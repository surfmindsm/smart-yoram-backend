...
@router.get(
    "/{member_id}/enhanced", response_model=schemas.member_enhanced.MemberEnhanced
)
def get_member_enhanced(
    ...
    member = (
        ...
        .options(
            ...
            joinedload(models.Member.member_addresses).joinedload(
                models.MemberAddress.address
            ),
...
@router.get(
    "/{member_id}/contacts", response_model=List[schemas.member_enhanced.MemberContact]
)
def get_member_contacts(
    ...
    contacts = (
        db.query(models.MemberContact)
        .filter(models.MemberContact.member_id == member_id)
        .all()
    )
...
@router.post(
    "/{member_id}/contacts", response_model=schemas.member_enhanced.MemberContact
)
...
@router.get(
    ...
    response_model=List[schemas.member_enhanced.MemberMinistry],
)
def get_member_ministries(
    ...
    ministries = (
        ...
        .order_by(models.MemberMinistry.appointed_on.desc())
        .all()
    )
...
@router.post(
    "/{member_id}/ministries", response_model=schemas.member_enhanced.MemberMinistry
)
...
# Sacrament endpoints
@router.get(
    "/{member_id}/sacraments", response_model=List[schemas.member_enhanced.Sacrament]
)
def get_member_sacraments(
    ...
    sacraments = (
        db.query(models.Sacrament)
        .filter(models.Sacrament.member_id == member_id)
        .order_by(models.Sacrament.date)
        .all()
    )
...
@router.post(
    "/{member_id}/sacraments", response_model=schemas.member_enhanced.Sacrament
)
...
# Transfer endpoints
@router.get(
    "/{member_id}/transfers", response_model=List[schemas.member_enhanced.Transfer]
)
def get_member_transfers(
    ...
    transfers = (
        ...
        .filter(models.Transfer.member_id == member_id)
